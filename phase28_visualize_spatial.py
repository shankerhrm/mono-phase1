...
def generate_spatial_plots(seed):
    filepath = f"phase28_spatial_results_seed{seed}.json"
    ...
    fig.suptitle('Phase 28: Spatial Ecosystem Evolution', fontsize=16)
    ...
    plt.tight_layout()
    plt.savefig(f"phase28_spatial_heatmaps_seed{seed}.png", dpi=300)
    plt.close()
    ...
    fig.tight_layout()
    plt.title('Phase 28: Global Spatial Metapopulation Dynamics')
    fig.legend(loc='upper right', bbox_to_anchor=(0.9, 0.9))
    plt.savefig(f'phase28_spatial_timeseries_seed{seed}.png', dpi=300)
    plt.close()
    print(f"Visualization complete: phase28_spatial_heatmaps_seed{seed}.png, phase28_spatial_timeseries_seed{seed}.png")
